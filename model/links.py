...
LINKS = {
    ...
    "Hollow punch set 1/8-1/2in + cutting mat":
        ("B07GCWY3HH", 17.99, "OWDEN 9 Pieces Leather Hollow Punch Set "
                              "(1/8in-1/2in) with a Cutting mat"),
...
LINK_VENDOR = {
    ...
    "Hollow punch set 1/8-1/2in + cutting mat": "Amazon",

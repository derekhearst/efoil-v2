...
|---|---|---|---|
| **G10 / FR4** | Woven glass cloth in cured epoxy, pressed into rigid sheet. Circuit-board material. | 1.85 g/cm³ | Anywhere a fastener lands |
| **Divinycell H80** | Closed-cell PVC structural foam | 80 kg/m³ | Sandwich core, lids |
| **Divinycell H200/H250** | Same foam, much denser | 200–250 kg/m³ | Mast hardpoint ring |
...
**Where solid G10 is non-negotiable:** rim ring, mast plate, module flange
rail, lid bolt pucks. Foam cannot hold a threaded insert, and an insert

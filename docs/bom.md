...
| [Neoprene sheet 3/8in 50A, wire bung](https://www.amazon.com/dp/B01LX83VS9) | 1 | sheet | $18.00 | $18.00 | estimate | 3/8 in. Punch O30 discs and drill 3 x O6.16 in a row at 8.96 pitch - ALL OVERSIZE. Pressed into the plate's O26.8 bore the disc closes to 26.8 x 11.94 and the holes to O5.5 at 8.0, so the BORE is what compresses it and the leads thread through by hand first at 5.3% and end up at 15.4%.  and drill 3 x O5.5 IN A ROW The row is the order the leads leave the mast in, so none has to be twisted. One sheet is a lifetime of bungs for both boards |

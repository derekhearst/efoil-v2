...
| Idaho sales tax, 6% (Ada County, no local) | 1 | allow | $444.40 | $444.40 | verified |  |
| **subtotal** | | | | **$564.40** | | |
...
| | |
|---|---:|
| **Grand total, 2 boards** | **$7,851.11** |
| Per board | $3,925.55 |
| Of which verified | $7,300.92  (93%) |
| Of which estimated | $550.19 |
| Linked to a real listing | 126 lines |
| Priced but NOT linked | 1 lines, $12.00 |
| Not linkable, but MEASURED (freight quotes) | 2 lines, $713.03 |
| Not linkable and still estimated | 1 lines, $120.00 |

## What is a board, and what is a shop

Some of the total above is not the cost of a board at all - it is tools, jigs and templates that exist afterwards and do not repeat. Splitting them out is the difference between "a board costs $3,926" and "a board costs $3,517 and I now own a vacuum rig, a crimper and a full template set".
